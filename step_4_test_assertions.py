...
class Output(BaseModel):
    ...
    total_visible_cards_top_wiki: int
...
async def test_fandom_website(browser, controller_with_actions, llm):
    ...
    assert parsed.total_visible_cards_top_wiki > 0, "Should have at least one visible card"
    assert parsed.page_title == "Everything To Know About Star Wars | Fandom"
